...
<body bgcolor="#e6e6e6";>
	...
	<div id="header">
	<h1>Voter Login </h1>
	<div class="news"><marquee behavior="right">Welcome to the Online Election System! </marquee></div>
	</div>
	<div id="container">
	...
	<br>Not yet registered? <a href="registeracc.php"><b>Register Here</b></a>
		...
		<div id="footer">
		<div class="bottom_addr">&copy; 2012 Online Election System. All Rights Reserved</div>
		</div>
	</div>
</body>
</html>