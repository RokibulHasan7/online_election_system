...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 05, 2022 at 03:23 PM
...
(1, 'Rokibul', 'Hasan', 'admin@example.com', '21232f297a57a5a743894a0e4a801fc3'),
...
(20, 'Aman', 'HOD', 2),
(22, 'Vaibhav', 'HOD', 2),
(23, 'Cristiano Ronaldo', 'Ballon', 0),
(24, 'Lionel Messi', 'Ballon', 0),
(25, 'Cristiano Ronaldo', 'FIFA', 0),
(26, 'Lionel Messi', 'FIFA', 0);

-- --------------------------------------------------------

--
-- Table structure for table `tbfreeze`
--

CREATE TABLE `tbfreeze` (
  `Fid` int(11) NOT NULL,
...
--
-- Dumping data for table `tbfreeze`
--

INSERT INTO `tbfreeze` (`Fid`, `position_id`, `freeze`) VALUES
(2, 13, 0),
(3, 1, 1),
(4, 2, 1),
(5, 5, 1),
...
(7, 'Rokibul', 'Hasan', 'rakib@gmail.com', 'a36949228c1d9146cace6359d88968e8');
...
--
-- Triggers `tbpositions`
--
DELIMITER $$
CREATE TRIGGER `TrFreeze` AFTER INSERT ON `tbpositions` FOR EACH ROW INSERT INTO `tbfreeze` (`position_id`) VALUES (NEW.position_id)
$$
DELIMITER ;
...
--
-- Indexes for table `tbfreeze`
--
ALTER TABLE `tbfreeze`
  ADD PRIMARY KEY (`Fid`);
...
--
ALTER TABLE `tbcandidates`
  MODIFY `candidate_id` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=27;

--
-- AUTO_INCREMENT for table `tbfreeze`
--
ALTER TABLE `tbfreeze`
